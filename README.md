...
A lightweight Google Chrome extension (Manifest V3) that automatically scrolls to the next video when a YouTube Short finishes playing.

## Features

- **Automatic Scrolling**: Seamlessly transitions to the next Short upon completion.
